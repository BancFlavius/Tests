...
public class T23 extends Canvas
{
    public void paint( Graphics g )
    {
        ...
        g.drawLine(100, 320, 300, 200);

        g.setColor(Color.black);

        // fonts
        g.drawString("This is where it starts from", 1, 50);
        g.drawString("Graphics are pretty neat.", 500, 100);
        g.setFont(new Font("Consolas", Font.PLAIN, 36)); // 36-pt plain
        g.drawString("Yes, they are.", 400, 200);

        g.setColor(Color.white);
        g.setFont(new Font("Calibri-BOLDITALIC-60", Font.BOLD+Font.ITALIC, 60)); // 60-pt italic bold
